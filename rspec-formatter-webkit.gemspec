# -*- encoding: utf-8 -*-
# stub: rspec-formatter-webkit 2.5.0.pre.20150220160939 ruby lib

Gem::Specification.new do |s|
  s.name = "rspec-formatter-webkit"
  s.version = "2.5.0.pre.20150220160939"
